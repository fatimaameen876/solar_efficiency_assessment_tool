...
Here’s a simple and clear description you can upload on GitHub:

This project is a web-based application designed to help users in Pakistan decide whether they should switch to solar energy. It analyzes a user’s monthly electricity bill, considers city-specific sunlight data, and calculates the most suitable solar system size.
